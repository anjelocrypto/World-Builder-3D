...
export default function RPMarkers({ activeTest, activeJob, activeGangMission, gangTerritoryStatus }: RPMarkersProps) {
  ...
  return (
    <>
      ...
      {(() => {
        const [ox, , oz] = LICENSING_OFFICE_DESK;
        return (
      ...
      {/* ════ Delivery Hub marker ══════════════════════════════════════════════ */}
      {(() => {
        const [dhx, , dhz] = DELIVERY_HUB_DOOR;
        return (
      ...
      {(() => {
        const [mcx, , mcz] = MEDIC_CENTER_DESK;
        return (
      ...
      {(() => {
        const [psx, , psz] = POLICE_STATION_DESK;
        return (
      ...
      {(() => {
        const [gx, , gz] = GOVERNMENT_OFFICE_DESK;
